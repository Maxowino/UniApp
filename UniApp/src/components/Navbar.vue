<template>
    <div>
        <v-app-bar color="purple">
            <v-app-bar-title>   <div class="titlebox">
            ...
            <v-spacer></v-spacer>
            <div>
                <v-btn to="/" color="orange" dark>Home</v-btn>
            </div>
            <div>
                <v-btn to="/aboutus" color="orange" dark> About</v-btn>
            </div>
            <div>
            ...
            <div>
                <v-btn to="/students" color="orange" > Students</v-btn>
            </div>
